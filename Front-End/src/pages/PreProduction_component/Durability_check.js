...
function Durability_check() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://127.0.0.1:5009/predict', [formData])
      .then(response => {
  ...
  const handleSubmit2 = (e) => {
    ...
    axios.post('http://127.0.0.1:5009/predict', requestData)
      .then(response => {
...
// eslint-disable-next-line react-hooks/exhaustive-deps
axios.post('http://127.0.0.1:5009/predict', requestData3)
  .then(response => {
  ...
  useEffect(() => {
    ...
    axios.get('http://127.0.0.1:5009/get_fiber_content')
      .then(response => {
