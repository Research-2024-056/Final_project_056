...
function DicisionMake() {
  ...
  const handleSendRequestfabric = () => {
    ...
    axios.post('http://127.0.0.1:5009/get_fabrics_for_end_use', requestData)
      .then(response => {
  ...
  useEffect(() => {
    ...
    axios.get('http://127.0.0.1:5009/load_all_fabric_data')
      .then(response => {
  ...
  useEffect(() => {
    // Fetch End Use values from the backend
    axios.get('http://127.0.0.1:5009/load_all_thread_data')
      .then(response => {
  ...
  useEffect(() => {
    // Fetch End Use values from the backend
    axios.get('http://127.0.0.1:5009/get_end_use')
      .then(response => {
  ...
  const handleClickFabricprice = (Fabrics) => {
    ...
    axios.post('http://127.0.0.1:5009/predict_futurePrice', post2)
      .then(response => {
        console.log(response.data);
